...
- [ ] **Fotos y descripciones reales de producto/"Quiénes somos"** — Joaquín las va subiendo/escribiendo directamente.
  - **2026-09-10, fotos reales de producto ya asignadas** (Joaquín las asignó él mismo desde `/admin/products`, verificado): Salmón Ahumado (200g-250g) → `salmon-pieza-chica-2.jpeg`, Salmón Ahumado (300g-350g) → `salmon-pieza-grande-3.jpeg`, Salmón Ahumado Desmenuzado → `salmon-desmenuzado-1.jpeg`. **Falta hacer lo mismo en producción** — la base de producción es independiente, nadie la tocó todavía.
  - **2026-09-15, home actualizada con contenido real (Joaquín, confirmado listo):** sección "Quiénes somos" de la home usa `quienes-somos-pablo-gellona.jpeg` (foto real del equipo, no placeholder). El collage de "Nuestros productos" de la home usa fotos reales de producto (`salmon-redimensionado-1.jpeg`, `salmon-redimensionado-2.jpeg`) más `salmon-recien-salido-home.jpg` (la misma foto del `.hero`, reutilizada a propósito). **Falta replicar en producción.**
  - **Pendiente todavía**: `/nosotros` ("Sobre nosotros" y "Nuestro proceso") sigue mostrando los banners placeholder genéricos (`salmon-recien-salido-quienes-somos.jpg` y `salmon-recien-salido-nuestro-proceso.jpg`) — el texto de esas dos secciones ya se actualizó con contenido real (2026-09-15), pero las fotos todavía no.
